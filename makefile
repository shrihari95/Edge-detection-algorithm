...
COMPONENT_FILES	:= ahb_master.sv ahb_slave.sv fill_in_buffer.sv overall_edge_det.sv flex_counter.sv flex_counter2.sv controller_ahb.sv address_update_r.sv get_address_r.sv fifo_r.sv address_update_w.sv fifo_w.sv controller_ahb_slave.sv decoder_ahb.sv mcu.sv gx_block_window1.sv gx_block_window2.sv gy_block_window1.sv gy_block_window2.sv result_1.sv result_2.sv
